...
public class NDIdiomSectionsPagerAdapter extends FragmentPagerAdapter {
    ...
    public NDIdiomSectionsPagerAdapter(@NonNull FragmentManager fm,Context context, ArrayList<Fragment> fragment_list) {
        super(fm);
        mContext = context;
