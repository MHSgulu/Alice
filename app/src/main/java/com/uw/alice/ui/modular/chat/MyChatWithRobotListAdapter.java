package com.uw.alice.ui.modular.chat;
...
public class MyChatWithRobotListAdapter extends RecyclerView.Adapter <RecyclerView.ViewHolder> {
    ...
    static class ViewHolder_Left extends RecyclerView.ViewHolder
    {
        TextView textView1;
    ...
    static class ViewHolder_Right extends RecyclerView.ViewHolder
    {
        TextView textView2;
    ...
    public MyChatWithRobotListAdapter(List<SingleChat> listBean){
        mlistBeans = listBean;
    }
