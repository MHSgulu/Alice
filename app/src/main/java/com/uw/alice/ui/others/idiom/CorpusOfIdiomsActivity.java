package com.uw.alice.ui.others.idiom;
...
import com.uw.alice.ui.others.NDIdiomSectionsPagerAdapter;
...
public class CorpusOfIdiomsActivity extends AppCompatActivity {
    ...
    private void initTab() {
        ...
        NDIdiomSectionsPagerAdapter adapter = new NDIdiomSectionsPagerAdapter(getSupportFragmentManager(),mContext,fragment_list);
